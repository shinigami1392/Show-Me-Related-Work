...
var base_url = "http://54.201.123.246:8081/relations/comment/add?"

describe("Add comment for a relation", function(){
    describe("PUT /", function() {	  
        var query_string = "domain=0&source=8248098&destination=6465053&user=user1&text=Test_Message";
        ...
        var query_string1 = "domain=0&source=00000000&destination=6465053&user=user1&text=Test_Message";
        ...
        var query_string2 = "do=0&source=8248098&destination=6465053&user=user1&text=Test_Message";
        ...
        var query_string3 = "domain=0&sour=8248098&destination=6465053&user=user1&text=Test_Message";
        ...
        var query_string4 = "domain=0&source=8248098&desti=6465053&user=user1&text=Test_Message";
        ...
        var query_string5 = "domain=0&source=8248098&destination=6465053&us=user1&text=Test_Message";
        ...
        var query_string6 = "domain=0&source=8248098&destination=8336572&user=Abc&text=testMessage";
        ...
        // Check for incorrect query parameter text
        var query_string7 = "domain=0&source=8248098&destination=6465053&user=user1&txt=Test_Message";
        var bad_url7 = base_url + query_string7;
        it("Check status code and text for incorrect user", function(done) {            
            request({
                method: 'PUT',
                uri: bad_url7,
